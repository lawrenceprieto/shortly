        ...
        <>
            <div className="footer">
                ...
                <div className="footer-socmeds">
                    <ul>
                        <li><i className="fa-lg fa-brands fa-square-facebook"></i></li>
                        <li><i className="fa-lg fa-brands fa-twitter"></i></li>
                        <li><i className="fa-lg fa-brands fa-pinterest"></i></li>
